...
`}>
      ...
      <div className="navbar">
        <div className="navbar-start">
          ...
          <a className=" text-3xl cursor-pointer  md:text-5xl font-extrabold 
               bg-linear-to-r from-pink-500 via-pink-400 to-pink-300
               bg-clip-text text-transparent  hover:shadow-sm duration-300 transition-shadow" href="/">bookStore</a>
        </div>
        <div className="navbar-end space-x-3">
          ...
          <a className="bg-pink-600 text-white p-2 rounded-md hover:bg-pink-500 duration-300 cursor-pointer" onClick={() => document.getElementById('my_modal_3').showModal()}>
            Login
          </a>
          <Login />
        </div>
